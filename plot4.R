...
plot(chartData$DateTime, chartData$Global_active_power, type = "l", xlab="", ylab = "Global Active Power")

#Top right
# Generate an X/Y line plot with global active power on the Y and date/time on the x
plot(chartData$DateTime, chartData$Voltage, type = "l", xlab="datetime", ylab = "Voltage")


# Bottom left
# Generate an X/Y line plot with global active power on the Y and date/time on the x
plot(chartData$DateTime, chartData$Sub_metering_1, type = "l", xlab="", ylab = "Energy sub metering")
...
# Bottom right
# Generate an X/Y line plot with global active power on the Y and date/time on the x
plot(chartData$DateTime, chartData$Global_reactive_power, type = "l", xlab="datetime", ylab = "Global_reactive_power")
